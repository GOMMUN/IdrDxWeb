...
@Slf4j
@Controller
@RequestMapping("/perbyprocess")
public class PerByProcessController {

	@Autowired
	private PerByProcessService service;
	...
	public String init() {
		...
		return "page/perByProcess";
	}

	@ResponseBody
	@GetMapping("/search")
	public List<performanceByProcess> find(String start, String end) {
